const PRODUCTS = [
  ...
  // --- LINEA DRILL BARBER (ACCESSORI) ---
  {
    id: "uomo-drill-barber-pennello",
    slug: "pennello-drill-barber",
    name: "Pennello Drill Barber",
    gender: "uomo",
    type: "accessori",
    tag: "Barber",
    price: 16,
    popularity: 32,
    line: "drill-barber",
    lineLabel: "Linea Drill Barber",
    image: "uomo/linea drill barber /pennello-drillbarber.png",
    short: "Pennello professionale per montare il sapone da barba.",
    benefits: [
      "Setole morbide e resistenti",
      "Montaggio schiuma rapido e uniforme",
      "Impugnatura ergonomica",
    ],
    howTo: "Inumidire il pennello, prelevare il sapone e montare in ciotola o sul viso.",
  },
  {
    id: "uomo-drill-barber-pennello-giallo",
    ...
    line: "drill-barber",
    lineLabel: "Linea Drill Barber",
    image: "uomo/linea drill barber /pennellogiallo-frillbarber.png",
    short: "Pennello con finitura gialla per rasatura tradizionale.",
    benefits: [
      "Setole compatte",
      "Finitura antiscivolo",
      "Ideale per schiume dense",
    ],
    howTo: "Bagnare e montare il sapone con movimenti circolari.",
  },
  {
    id: "uomo-drill-barber-pennello-nero",
    slug: "pennello-nero-drill-barber",
    name: "Pennello Nero Drill Barber",
    gender: "uomo",
    type: "accessori",
    tag: "Barber",
    price: 16,
    ...
    line: "drill-barber",
    lineLabel: "Linea Drill Barber",
    image: "uomo/linea drill barber /pennellonero-drillbarber.png",
    short: "Pennello nero elegante per rasatura classica.",
    benefits: [
      "Design essenziale",
      "Asciugatura rapida",
      "Comfort di utilizzo",
    ],
    howTo: "Utilizzare con saponi o creme da barba.",
  },
  {
    id: "uomo-drill-barber-pettine",
    ...
    line: "drill-barber",
    lineLabel: "Linea Drill Barber",
    image: "uomo/linea drill barber /pettinedrillbarber.png",
    short: "Pettine per definire barba e baffi.",
    benefits: [
      "Denti levigati anti-impiglio",
      "Compatto e resistente",
      "Perfetto per ritocchi di precisione",
    ],
    howTo: "Pettinare barba e baffi prima dello styling.",
  },
  // --- ALTRI PRODOTTI (ACCESSORI) ---
  {
    id: "uomo-altri-prodotti-asciugamano",
    slug: "asciugamano-professionale",
    name: "Asciugamano Professionale",
    gender: "uomo",
    type: "accessori",
    tag: "Pro",
    price: 10,
    popularity: 36,
    line: "altri-prodotti",
    lineLabel: "Altri prodotti",
    image: "uomo/altri prodotti/asciugamano.png",
    short: "Asciugamano professionale per salone e routine a casa.",
    benefits: [
      "Assorbenza elevata",
      "Morbido e duraturo",
      "Facile manutenzione",
